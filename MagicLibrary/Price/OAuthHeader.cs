...
namespace PriceLibrary
{
    ...
    internal class OAuthHeader
    {
        ...
        protected String appToken = "KKhxtu2s49s5d3fH";

        /// <summary>App Secret</summary>
        protected String appSecret = "EShtio9Qk5XAK8hvAewPTCIAlkUWTM0F";

        /// <summary>Access Token (Class should also implement an AccessToken property to set the value)</summary>
        protected String accessToken = "oNHvOF1RuJd7Vv8ur8PzuEqzlaEFlLaB";

        /// <summary>Access Token Secret (Class should also implement an AccessToken property to set the value)</summary>
        protected String accessSecret = "XNcpx5Tc9aHEvGVaEfUBFTzvQuV3Jaak";
