...
using MyMagicCollection.vnext.Models;

namespace MyMagicCollection.vnext.Migrations
{
    [ContextType(typeof(MyMagicCollection.vnext.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("MyMagicCollection.vnext.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("MyMagicCollection.vnext.Models.ApplicationUser", "UserId");
                });
